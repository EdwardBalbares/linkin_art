...
<div class="side-header">
    <img src="./assets/images/logo.png" width="120" height="120" alt="Linkin Art Collection"> 
...
<hr style="border:1px solid; background-color:#8a7b6d; border-color:#3B3131;">
    ...
    <a href="#stockout"   onclick="showStockOut()" ><i class="fa fa-exclamation-triangle"></i> Stock Out</a>
